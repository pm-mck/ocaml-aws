...
let parse_error code err =
  let errors =
    [Errors_internal.InsufficientCapabilitiesException;
    Errors_internal.AlreadyExistsException;
    Errors_internal.LimitExceededException] @ Errors_internal.common in
